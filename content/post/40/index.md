...
最近投入 Explosion 的时间并不是很多，RHI 重构算是最近的主要进展了，我之前写过一篇文章叫做 [《醒醒吧，静态多态根本没有这么香》](https://flyandnotdown.github.io/post/39/)，其实主要纠结的地方在于要不要追求极限性能，把 RHI 的主要架子完全用模板实现，但我最后还是放弃了。
...
我很喜欢拿反射系统说事，之前也写过 [一篇对反射系统的剖析](https://flyandnotdown.github.io/post/33/)，不过那是针对 UnrealEngine 的。反射系统在游戏引擎中最大的作用，无非就两个：
